...
# Questions
 ...
 - does GP have applications to aerodynamics or any complex, difficult to model dynamics?
 - how to determine the correct amount of datapoints to use?
 - low lengthscale -> overfitting
